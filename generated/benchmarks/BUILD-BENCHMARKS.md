...
| Phase | Native | WASM |
|-------|-------:|-----:|
| Parse | 220.6 ms | 850.7 ms |
| Insert nodes | 63.4 ms | 65.1 ms |
| Resolve imports | 14.2 ms | 18.4 ms |
| Build edges | 116.5 ms | 123.2 ms |
| Structure | 6.1 ms | 9.3 ms |
| Roles | 21.3 ms | 17.2 ms |
| Complexity | 8.2 ms | 338.1 ms |

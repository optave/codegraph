...
| 5 | 4.33 | [joernio/joern](https://github.com/joernio/joern) | 3,401 | 🛡️ | 2026-08-08 | Scala | Apache-2.0 | Full CPG platform (AST+CFG+PDG) for vulnerability discovery, Scala query DSL (CPGQL), analyzes source/bytecode/binaries in one graph, daily automated releases, 7 years old |
...
- **Community** (1-5): stars-anchored band — 5 = 10,000+ stars, 4 = 1,000–9,999, 3 = 100–999, 2 = 10–99, 1 = 0–9. Applied uniformly across all 38 Tier 1 entries as of 2026-08-09 (previously ad hoc per-project judgment)
...
### vs codebase-memory-mcp (#2, 38,238 stars — no longer "immature")
- **Explosive growth, now sustained**: 793 → 38,238 stars (48x) since our last check, 3,044 forks, 427 open issues, 163 subscribers — genuine large-scale engagement. Single-developer C project, created 2026-02-24
...
### vs code-review-graph (#3, 29,499 stars)
- **Massive, fast-growing community**: 4,309 → 29,499 stars (6.8x), 2,700 forks — now one of the largest communities in this space
...
### vs colbymchenry/codegraph (#9, 65,505 stars — 212x growth, Rust rewrite)
- **Explosive, sustained growth**: 308 → 65,505 stars (212x) since March — now the single most-starred tool in this entire document, ahead of GitNexus, codebase-memory-mcp, and code-review-graph. 4,122 forks and 398 open issues on a repo created 2026-01-18 (~7 months old)
...
- **Explosive popularity + real engineering backing**: 12,343 stars (re-verified 2026-08-09), Trendshift-featured, built by Zilliz (the company behind the Milvus vector database). VS Code extension alongside the MCP server, setup docs for 10+ agent clients
